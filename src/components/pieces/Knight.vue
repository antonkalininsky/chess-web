...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 45 45">
        <!-- alap -->
        <g :fill="colorSetter(props.color || '')" stroke="#000" stroke-width="1.5" stroke-linecap="round"
        ...
        <!-- vonalak -->
        <g :fill="colorSetter(colorReverser(props.color || ''))" :stroke="colorSetter(colorReverser(props.color || ''))"
